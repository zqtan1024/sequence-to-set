...
class Evaluator:
    def __init__(self, dataset: Dataset, input_reader: JsonInputReader, text_encoder: BertTokenizer, logger, no_overlapping: bool,
    ...
    def compute_scores(self):
        ...
        self._log("")
        self._log("--- Entities (named entity recognition (NER)) ---")
